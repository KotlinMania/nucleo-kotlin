...
This file is the quick-reference operating contract for nucleo-kotlin. The longer
...
nucleo-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`nucleo`](https://crates.io/crates/nucleo). Upstream Rust is the behavioral oracle while the
