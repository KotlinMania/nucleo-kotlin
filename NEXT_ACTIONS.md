...
- **Function parity:** 125/227 matched (target 263) — 55.1%
- **Class/type parity:** 28/45 matched (target 51) — 62.2%
- **Combined symbol parity:** 153/272 matched (target 314) — 56.2%
- **Average inline-code cosine:** 0.49 (function body across 18 matched files)
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:chars/normalize.rs` vs expected `chars/normalize.rs`
...
### 9. matcher.fuzzy_optimal

- **Target:** `nucleo.FuzzyOptimal [PROVENANCE-FALLBACK]`
- **Similarity:** 0.36
- **Dependents:** 0
- **Priority Score:** 40706.4
- **Functions:** 3/7 matched
- **Missing functions:** `fuzzy_match_optimal`, `setup`, `score_row`, `populate_matrix`
- **Types:** 0/0 matched
- **Missing types:** _none_
...
- **Missing functions:** `bonus_for`, `calculate_score`
- **Types:** 0/0 matched
- **Missing types:** _none_
...
- **Similarity:** 0.69
- **Dependents:** 0
- **Priority Score:** 10503.1
- **Functions:** 4/5 matched (target 4)
- **Missing functions:** `substring_match_ascii_with_prefilter`
- **Types:** 0/0 matched
- **Missing types:** _none_
...
- **Missing functions:** `fuzzy_match_greedy_`
- **Types:** 0/0 matched
- **Missing types:** _none_
