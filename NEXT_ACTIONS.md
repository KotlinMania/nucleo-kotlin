...
- **Class/type parity:** 23/23 matched (target 39) — 100.0%
- **Combined symbol parity:** 126/128 matched (target 202) — 98.4%
- **Average inline-code cosine:** 0.65 (function body across 5 matched files)
- **Average documentation cosine:** 0.50 (doc text across 5 matched files)
