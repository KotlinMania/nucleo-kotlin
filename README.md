# nucleo-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fnucleo--kotlin-blue.svg)](https://github.com/KotlinMania/nucleo-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/nucleo-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/nucleo-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/nucleo-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/nucleo-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`helix-editor/nucleo`](https://github.com/helix-editor/nucleo).

**Original Project:** This port is based on [`helix-editor/nucleo`](https://github.com/helix-editor/nucleo). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `helix-editor/nucleo`
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:nucleo-kotlin:0.1.1")
}
```
...
This Kotlin port is distributed under the same MPL-2.0 license as the upstream [`helix-editor/nucleo`](https://github.com/helix-editor/nucleo). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the nucleo authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`helix-editor/nucleo`](https://github.com/helix-editor/nucleo) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
